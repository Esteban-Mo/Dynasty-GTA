...
export const Logo = () => {
    ...
    return (
        <div
            className="absolute top-1/4 left-1/2 transform z-10 w-1/4 -translate-x-1/2 -translate-y-1/2 rounded-lg flex flex-col items-center h-80">
                <img src={"/img/logo.webp"} alt="Logo" style={{height: "auto", width: '100%', padding: '30px'}}/>
